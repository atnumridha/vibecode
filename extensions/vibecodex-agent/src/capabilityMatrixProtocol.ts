...
const capabilityDefinitions: readonly CapabilityDefinition[] = [
	...
	capability('protocolDiagnostics', 'Transparent JSON-RPC diagnostics, backend launch readiness, runtime readiness, tool timeline, and redacted client-state snapshots', ['codex', 'vibecodex'], ['context.backendLaunchStatus', 'context.protocolStatus', 'context.runtimeReadinessStatus', 'context.toolTimelineStatus', 'context.clientState'], [
